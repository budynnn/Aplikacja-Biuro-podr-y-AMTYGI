...
<div class="travel-block">
    ...
    <aside class="description">
        <h2>Szwajcaria</h2>
        <p>Szwajcaria to kraj Alp, czystych jezior i perfekcji. Zachwyca krajobrazami,
           kulturą oraz spokojem. Znajdziesz tu urokliwe miasta takie jak Zurych i Lucerna,
           a także jedne z najpiękniejszych górskich widoków w Europie. Idealne miejsce dla
           miłośników natury, sportów zimowych i luksusowego wypoczynku.</p>
    </aside>
