...
<div class="travel-block">
    ...
    <aside class="description">
        <h2>Hiszpania</h2>
        <p>Hiszpania to kraj pełen słońca, kultury i wyjątkowej kuchni. Od tętniącej życiem Barcelony po historyczne uliczki Sewilli – każdy znajdzie tu coś dla siebie.</p>
    </aside>
