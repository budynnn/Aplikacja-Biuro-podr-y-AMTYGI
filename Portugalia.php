...
<div class="travel-block">
    ...
    <aside class="description">
        <h2>Portugalia</h2>
        <p>Portugalia to kraj wyjątkowej atmosfery, pięknych wybrzeży i bogatej historii. 
           Lizbona zachwyca kolorowymi uliczkami, Porto słynie z winnic i mostów, 
           a Algarve oferuje jedne z najpiękniejszych plaż w Europie. Idealne miejsce 
           na słoneczne wakacje i odkrywanie południowej kultury.</p>
    </aside>
